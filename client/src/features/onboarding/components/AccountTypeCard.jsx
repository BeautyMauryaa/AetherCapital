 ...
 active,
  ...
  return (
    <div
      ...
      className={`relative p-5 sm:p-6 lg:p-8 rounded-[20px] sm:rounded-[24px] border-2 transition-all duration-300 flex flex-col h-full
        ${
          disabled
    ...
    >
      ...
      {/* Text */}
      <h3
        className={`text-[17px] sm:text-[20px] font-bold mb-2 sm:mb-3 tracking-tight transition-colors ${
          active
            ? isDark
              ? "text-white"
              : "text-slate-900"
      ...
      <p
        className={`text-[13px] sm:text-[14px] leading-relaxed transition-colors ${
          active
            ? isDark
              ? "text-white/60"
              : "text-slate-500"
      ...
      {active && (
        <div
          className={`absolute -bottom-1 left-1/2 -translate-x-1/2 w-3/4 h-4 blur-xl rounded-full
            ${
              isDark
                ? "bg-[#9C75E6]/20"
                : "bg-[#9C75E6]/15"
