...
// const StepSidebar = () => {
//   // Pulling both current position and furthest progress
//   const currentStep = useOnboardingStore((s) => s.step);
//   const reachedStep = useOnboardingStore((s) => s.reachedStep);
//   const { theme, toggleTheme } = useTheme(); 
  
//   const isDark = theme === 'dark';

//   // Progress is calculated based on reachedStep so the bar doesn't shrink when editing
...
//           // Logic: Step is completed if we have reached a further step, 
//           // and it is NOT the one we are currently looking at.
