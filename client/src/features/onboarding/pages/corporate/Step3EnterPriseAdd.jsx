      ...
      <div className="space-y-12">
        ...
        <section className="space-y-8">
          <div className="flex items-center gap-4 mb-2">
            <h3
              className="text-[11px] font-bold tracking-[0.25em] uppercase whitespace-nowrap flex items-center gap-2"
              style={{ color: "var(--text-main)", opacity: 0.4 }}
            >
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="space-y-3">
              <label
                className="text-[11px] font-medium uppercase tracking-widest ml-1"
                style={labelStyle}
              >
                Country *
              </label>
          ...
          >
            ...
            >
              ...
              <MapPin
                ...
                style={
                  !hasAddress ? { color: "var(--text-main)", opacity: 0.1 } : {}
                }
              />
                         {" "}
            </div>
        ...
        <div className="space-y-6 pt-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer group w-fit">
            ...
            <div
              ...
              onClick={() =>
                handleFieldChange("mailingSame", !formData.mailingSame)
              }
            >
                           {" "}
              {formData.mailingSame && (
          ...
          <div className="space-y-3 pt-4">
            ...
                       {" "}
            <p
              className="text-[11px] italic ml-1"
              style={{ color: "var(--text-main)", opacity: 0.2 }}
            >
